    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('agency_lang', models.CharField(choices=[('EN', 'English'), ('NL', 'Dutch'), ('SV', 'Swedish')], default='EN', max_length=2)),
        ...
        migrations.CreateModel(
            name='Shapes',
            fields=[
                ('shape_id', models.CharField(default=0, max_length=100, primary_key=True, serialize=False)),
        ...
        migrations.CreateModel(
            name='Trips',
            fields=[
                ('trip_id', models.CharField(default=0, max_length=100, primary_key=True, serialize=False)),
                ...
                ('shape', models.ForeignKey(default=0, on_delete=django.db.models.deletion.CASCADE, to='lightrail.shapes')),
            ],
        ),
        migrations.CreateModel(
            name='StopTimes',
            fields=[
                ...
                ('stop_id', models.ForeignKey(default=0, on_delete=django.db.models.deletion.PROTECT, to='lightrail.stops')),
