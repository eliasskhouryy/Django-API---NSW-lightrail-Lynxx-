...
class Stops(models.Model):
    ...
    stop_lat = models.DecimalField(max_digits=30, decimal_places=6, null=True)
    stop_lon = models.DecimalField(max_digits=30, decimal_places=6, null=True)
    zone_id = models.CharField(max_length=255, null=True)
    stop_url = models.URLField(max_length=200, null=True)
    location_type = models.CharField(max_length=255, null=True)
    parent_station = models.CharField(max_length=255, null=True)
    stop_timezone = models.CharField(max_length=255, null=True)
    wheelchair_boarding = models.IntegerField(null=True)
    platform_code = models.IntegerField(null=True)
